...
Render3D.prototype = new WGLObject;
Render3D.prototype.constructor = Render3D;

Render3D.prototype.init = function(){
    this.initGL();
};

Render3D.prototype.initGL = function(){
    var gl = this.getGL();   
...
Render3D.prototype.initRenderMode = function(gl){
...
Render3D.prototype.frameOn = function(){
    var gl = this.getGL();
...
Render3D.prototype.clearFrame = function(){
...
Render3D.prototype.frameOff = function(){
    this.getGL().bindFramebuffer(this.getGL().FRAMEBUFFER, null);
}

Render3D.prototype.frameInit = function(){
    var gl = this.getGL();
...
//
Render3D.prototype.bufferRenderInit = function(info){
//    console.log(info);
    var gl = this.getGL(),
...
//
Render3D.prototype.bufferTextureInit = function(info){
...
//
Render3D.prototype.process = function(){
    if(this.getConfig().renderToFrame)
        this.frameOn();
